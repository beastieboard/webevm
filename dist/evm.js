...
class EVM {
    ...
    runInterpreter(message, opts = {}) {
        ...
        const InterpreterCls = message.isPure ? interpreter_1.PureInterpreter : interpreter_1.Interpreter;
        const interpreter = new InterpreterCls(this, this.eei, env, message.gasLimit);
